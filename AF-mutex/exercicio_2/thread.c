...
void * matrix_mult_worker(void *arg) {
    ...
    while (linha_atual < tamanho_matriz) {
        ...
        //Mutex necessario nessa secao de codigo pois aqui eh onde as variaves globais de linha e coluna sao incrementadas e
        //atribuidas as variaveis locais, o paralelismo eh garantido ainda pois as N threads podem realizar suas operacoes
        //de multiplicacao ao mesmo tempo, somente nao referentes ao mesmo elemento da matriz resultado. 
